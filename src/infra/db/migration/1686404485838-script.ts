...
export class Script1686404485838 implements MigrationInterface {
  ...
  public async up (queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE TABLE "account_type" ("id" SERIAL NOT NULL, "name" character varying(200) NOT NULL, CONSTRAINT "PK_215ed371eba21a3ec30c2cfa1de" PRIMARY KEY ("id"))')
    await queryRunner.query('CREATE TABLE "account" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "typeId" integer NOT NULL, CONSTRAINT "PK_54115ee388cdb6d86bb4bf5b2ea" PRIMARY KEY ("id"))')
    ...
    await queryRunner.query('ALTER TABLE "account" ADD CONSTRAINT "FK_468b5869141a9a5b815198492d0" FOREIGN KEY ("typeId") REFERENCES "account_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION')
    ...
    // INSERTS
    await queryRunner.query('INSERT INTO public.account_type ("name") VALUES(\'admin\')')
    await queryRunner.query('INSERT INTO public.account_type ("name") VALUES(\'user\')')
  ...
  public async down (queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "account" DROP CONSTRAINT "FK_468b5869141a9a5b815198492d0"')
